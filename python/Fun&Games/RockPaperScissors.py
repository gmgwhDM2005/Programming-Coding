...
#Includes: File handling and Results viewed!
...
def menu(opt):
     if opt=='A' or opt=='a':
          ...
          output={
               ...
               t.sleep(2),
               print('The aim of the game is to win all 3 rounds'),
               t.sleep(3),
               print('The user goes 1st with choosing either: Rock, Paper or Scissors'),
               t.sleep(3),
               print('The computer then replies with: Rock, Paper or Scissors'),
               t.sleep(3),
               print('U=User, C=Computer'),
               t.sleep(2),
               print('U=Rock, C=Paper, Paper Wins'),
               print('U=Rock, C=Scissors, Rock Wins'),
               print('U=Paper, C=Scissors, Scissors Wins'),
               print('If U = C, Tie no one wins\n '),
               t.sleep(5)
            }
          return output
     else:
...
for i in range(3):
     ...
     #Computer Results
     if num==1:
          print('Computer: ' + rps[0])
     elif num==2:
          print('Computer: ' + rps[1])
     else:
          print('Computer: ' + rps[2])
     t.sleep(1)
